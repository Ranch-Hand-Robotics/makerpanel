...
<div class="hero-section" style="text-align: center; padding: 4rem 0 3rem; position: relative; overflow: hidden; background: linear-gradient(135deg, #1a1a1a 0%, #2d2d2d 50%, #1a1a1a 100%); border-radius: 0; margin: -1rem -2rem 2rem; border-bottom: 2px solid #4a9d5f;">
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 2rem; margin: 3rem 0;">
  ...
  <div class="feature-card" style="padding: 2rem; border-radius: 0.5rem; background: linear-gradient(135deg, #2a2a2a 0%, #1f1f1f 100%); position: relative; overflow: hidden; border: 1px solid #4a9d5f;">
    ...
    <p style="color: #b0b0b0; position: relative; z-index: 1; font-size: 1rem;">Mix and match panels for your specific needs</p>
  </div>
  <div class="feature-card" style="padding: 2rem; border-radius: 0.5rem; background: linear-gradient(135deg, #2a2a2a 0%, #1f1f1f 100%); position: relative; overflow: hidden; border: 1px solid #4a9d5f;">
    <div style="font-size: 3.5rem; margin-bottom: 1rem; position: relative; z-index: 1;">🌟</div>
